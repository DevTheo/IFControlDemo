...
namespace Frotz
{
    ...
    internal static class os_
    {
        internal static IIFRuntime runtime { get; set; } = null;
        internal static IFileService fileIO { get { return runtime != null ? runtime.FileIO : null; } }
            ...
            try
            {
                while (true)
                {
                    ...
                    while (entries.Count == 0)
                    {
                        ...
                        System.Threading.Tasks.Task.Delay(10).GetAwaiter().GetResult();
