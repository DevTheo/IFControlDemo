...
namespace ZTools
{
    internal static class InfoDump
    {
        ...
        static void show_help(String program)
        {
            ...
            os_.runtime.Debug.LogError("usage: %s [options...] story-file [story-file...]\n\n", program);
            os_.runtime.Debug.LogError("INFODUMP version 7/3 - display Infocom story file information. By Mark Howell\n");
            os_.runtime.Debug.LogError("Works with V1 to V8 Infocom games.\n\n");
            os_.runtime.Debug.LogError("\t-i   show game information in header (default)\n");
            os_.runtime.Debug.LogError("\t-a   show abbreviations\n");
            os_.runtime.Debug.LogError("\t-m   show data file map\n");
            os_.runtime.Debug.LogError("\t-o   show objects\n");
            os_.runtime.Debug.LogError("\t-t   show object tree\n");
            os_.runtime.Debug.LogError("\t-g   show verb grammar\n");
            os_.runtime.Debug.LogError("\t-d   show dictionary\n");
            os_.runtime.Debug.LogError("\t-f   full report (all of the above)\n");
            os_.runtime.Debug.LogError("\t-c n number of columns for dictionary display\n");
            os_.runtime.Debug.LogError("\t-w n display width (0 = no wrap)\n");
            os_.runtime.Debug.LogError("\t-s Display Inform symbolic names in object and grammar displays\n");
            os_.runtime.Debug.LogError("\t-u <file> Display symbols from file in object and grammar displays (implies -s)\n");
