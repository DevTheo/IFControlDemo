...
namespace Frotz.Generic
{
    internal static class Files
    {
        ...
        internal static void script_open()
        {
            ...
            var sfpFile = os_.fileIO.CreateLocalFileForWriteAsync(script_name, true).GetResults();
            if ((sfp = new StreamWriter(os_.fileIO.GetStreamWriterAsync(sfpFile).GetResults().AsStreamForWrite())) != null)
            {
        ...
        internal static void record_open()
        {
            ...
            if (os_.read_file_name(out new_name, command_name, FileTypes.FILE_RECORD) == true)
            {
                ...
                var rfpFile = os_.fileIO.OpenLocalFileForWriteAsync(command_name).GetResults();
                if ((rfp = new System.IO.StreamWriter(os_.fileIO.GetStreamWriterAsync(rfpFile).GetResults().AsStreamForWrite())) != null)
                {
        ...
        internal static void replay_open()
        {
            ...
            if (os_.read_file_name(out new_name, command_name, FileTypes.FILE_PLAYBACK))
            {
                ...
                //pfpFile = os_.fileIO.OpenLocalFileForWriteAsync()
