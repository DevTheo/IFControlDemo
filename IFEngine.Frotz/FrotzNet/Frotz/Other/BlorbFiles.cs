            ...
            if (_chunks.ContainsKey(start - 8)) {
                ...
                switch (type) {
                    ...
                    case "Plte":
                        ...
                        break;
                    default:
                        os_.runtime.Debug.LogDebug("".PadRight(level) + ":" + "Type:" + type + ":" + length);
                        break;
                }
            }
        ...
        internal static Blorb ReadBlorbFile(byte[] StoryData) {
            ...
            if (_blorb.MetaData != null) {
                ...
                catch (Exception ex)
                {
                    ...
                    //#endif
                    (new Windows.UI.Popups.MessageDialog("Exception reading metadata:" + ex)).ShowAsync().GetResults();
