...
namespace Frotz.Generic
{
    internal static class ZObject
    {
        ...
        internal static zword object_address(zword obj)
        {
            ...
            if (obj > ((main.zmachineVersion <= 3) ? 255 : MAX_OBJECT))
            {
            ...
            if (main.zmachineVersion <= 3)
                return (zword) (main.object_table + ((obj - 1) * O1_SIZE + 62));
            else
                return (zword) (main.object_table + ((obj - 1) * O4_SIZE + 126));
        ...
        //    zbyte value;
            ...
            //if (Process.zargs[1] > ((main.zmachineVersion <= 3) ? 31 : 47))
        ...
        //    mask = (zbyte) ((main.zmachineVersion <= 3) ? 0x1f : 0x3f);
        ...
        //        if ((main.zmachineVersion <= 3 && !((value & 0xe0) > 0)) || (main.zmachineVersion >= ZMachine.V4 && !((value & 0xc0) > 0)))
        //        {
        ...
        //        if (main.zmachineVersion >= ZMachine.V4 && (value & 0x80) > 0)
        //            prop_addr++;
