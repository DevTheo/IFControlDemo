...
{
    public sealed class EmptyImplementation : IScreenSetup, ISimpleTextOnlySupport, IComplexTextSupport, IBasicImageSupport, IAnimationSupport, IBasicSoundSupport, IFileStorageSupport, IOtherInputSupport
    {
        ...
        {
            return baseImpl.FRead(temp, sizeOfValue, len, fileNum); 
        }
